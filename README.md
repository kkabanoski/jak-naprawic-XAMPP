...
## Cofnąć do folderu mysql:
![https://i.imgur.com/3ZJmTcP.png](https://i.imgur.com/3ZJmTcP.png)

## Wejść w folder data:
![https://i.imgur.com/uO7CXMD.png](https://i.imgur.com/uO7CXMD.png)

## Zawartość folderu data:
![https://i.imgur.com/zI5iLn8.png](https://i.imgur.com/zI5iLn8.png)

## Następnie należy kliknąć kombinacje klawiszową `Ctrl + V`:
![https://i.imgur.com/mPdlcpt.png](https://i.imgur.com/mPdlcpt.png)

## Uruchamiamy program XAMPP:
![https://i.imgur.com/ZCWLzHB.png](https://i.imgur.com/ZCWLzHB.png)

## Następnie klikamy przycisk start w rzędach które odopowiadają modułom Apache i MySQL:
![https://i.imgur.com/s6otDuH.png](https://i.imgur.com/s6otDuH.png)
